...
const projectImages: React.ReactNode[] = [
  <div key="img-0" className="flex h-full items-center justify-center bg-gradient-to-br from-amber-50 to-amber-100">
  ...
  <div key="img-1" className="flex h-full items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100">
    <div className="text-center">
  ...
  <div key="img-2" className="flex h-full items-center justify-center bg-gradient-to-br from-teal-50 to-teal-100">
    <div className="text-center">
...
export default function Portfolio() {
  ...
  const tags = [
    ["Next.js", "Tailwind CSS", "Reservation System"],
    ["React", "TypeScript", "Booking System"],
    ["Next.js", "Tailwind CSS", "Appointment System"],
  ];
